...
urlpatterns = patterns('',
  ...
  url(r'^safari/v1/log$', 'django_project.views.apn_log', name='apn_log'),
  url(r'^safari/v1/pushPackages/(?P<website_push_id>.+)$', 'django_project.views.apn_push_package', name='apn_push_package'),
  url(r'^safari/v1/devices/(?P<device_id>.+)/registrations/(?P<website_id>.+)$', 'django_project.views.apn_device_register', name='apn_device_register'),  
